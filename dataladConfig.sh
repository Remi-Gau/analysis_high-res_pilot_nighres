...
URL_DER='git@gin.g-node.org:/cpp_brewery/analysis_V5_high-res_pilot_nighres_derivatives.git'

# derivatives/preproc sibling url
# for DEMO use: git@gin.g-node.org:/cpp_brewery/CPP_visMotion-cpp_spm-preproc.git
URL_DER_PREPROC='git@gin.g-node.org:/cpp_brewery/analysis_V5_high-res_pilot_nighres.git'
